...
function Dados() {
  function rollDice() {
    var elDiceOne = document.getElementById("dice1") as HTMLElement;
    var elDiceTwo = document.getElementById("dice2") as HTMLElement;
  ...
  return (
    <aside id="asideDados" onClick={rollDice}>
      <div className="game">
